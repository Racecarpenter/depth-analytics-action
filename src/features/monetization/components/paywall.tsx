 ...
 * and doesn't have an active Pass. Three paths, matching the product brief
 * exactly: refer someone in for free, buy a small pack, or go unlimited for
 * 30 days. `returnTo` is the current pathname, so Stripe Checkout comes back
 * to exactly where this was shown.
 *
 ...
 */
export function Paywall({ returnTo, justPurchased = false }: { returnTo: string; justPurchased?: boolean }) {
